...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002157052334"))
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002230607811"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6367302898, 7277357700").split()):
        ADMINS.append(int(x))
except ValueError:
